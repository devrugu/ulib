...
std::vector<std::string> XmlInterpreter::split(const std::string& s, char delimiter)
{
...
std::string XmlInterpreter::stripParentheses(const std::string& s)
{
    if (s.front() == '(' && s.back() == ')') {
...
std::vector<std::string> XmlInterpreter::splitTuples(const std::string& s)
{
...
std::vector<std::string> XmlInterpreter::splitOuterGroups(const std::string& s)
{
